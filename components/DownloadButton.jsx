...
// //     setDownloadPending(true);
// //     createAndLoadAd();
// //   }, [loaded, currentAd, createAndLoadAd]);
...
// //       console.log("Download started from:", imageUrl);
...
// //         downloadResult.uri
// //       );
// //       console.log("Saved to library:", assetResult);
...
//         setIsRewarded(true);
//         setDownloadPending(true);
//         setShouldLoadNewAd(false); // Prevent loading new ad after reward
//       }
//     );
...
//         setLoaded(false);
//         setCurrentAd(null);
//         // Only load new ad if we haven't earned a reward yet
//         if (shouldLoadNewAd) {
//           createAndLoadAd();
//         }
//       }
...
//         setDownloadPending(false);
//         setLoaded(false);
//         // Only retry if we haven't earned a reward yet
//         if (shouldLoadNewAd) {
//           setTimeout(createAndLoadAd, 1000);
//         }
//       }
